...
public class GearTest extends Utility {
    ...
    public void userShouldAddProductSuccessFullyToShoppingCart() throws InterruptedException {
        ...
        clickOnTheElement(By.xpath("//a[normalize-space()='Overnight Duffle']"));
        ...
        clickOnTheElement(By.xpath("//button[@id='product-addtocart-button']"));
        Thread.sleep(1000);
        ...
        //Verify the Qty is ‘3’
        expectedMessage = "3";
        actualMessage = getAttValueFromElement(By.xpath("(//input[@class='input-text qty'])[1]"));
        Assert.assertEquals(expectedMessage, actualMessage);
        ...
        clickOnTheElement(By.xpath("//span[normalize-space()='Update Shopping Cart']"));
        Thread.sleep(1000);
